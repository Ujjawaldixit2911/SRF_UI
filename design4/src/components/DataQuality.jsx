...
export default function DataQuality() {
  return (
    <div className="view active" id="view-dq">
      ...
      <div style={{ padding: '16px 20px', background: 'var(--blue-soft, #e0f2fe)', color: 'var(--navy, #1e3a8a)', border: '1px solid #bfdbfe', borderRadius: '4px', marginTop: '24px', fontSize: '13px', lineHeight: '1.5' }}>
